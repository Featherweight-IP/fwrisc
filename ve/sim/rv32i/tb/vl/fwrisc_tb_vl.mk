...
FWRISC_TB_VL_DIR := $(dir $(lastword $(MAKEFILE_LIST)))

ifneq (1,$(RULES))

ifeq (vl,$(SIM))
SRC_DIRS += $(FWRISC_TB_VL_DIR)
endif

FWRISC_TB_VL_SRC_FILES=$(wildcard $(FWRISC_TB_VL_DIR)/*.cpp)
...
libfwrisc_tb_vl.o : fwrisc_tb_hdl.cpp vl_translate.d
